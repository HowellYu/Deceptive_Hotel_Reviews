...
"resource": {
  ...
  "rules":[
    [["if",0],["add",0,4,6,10,11,12,13,8,9]],
    [["if",1],["add",1]],
    [["if",2],["add",2,7,11,12]],
    [["if",3],["add",3,12]],
    [["if",4,5,6,7],["add",5]]]
...
function ob(a,b,c){var d=this.B();L(a,function(){b instanceof w&&b.m(d)},function(){c instanceof w&&c.m(d)})}function pb(a,b,c){for(var d=a.split("."),e=B,f=0;f<d.length-1;f++)if(e=e[d[f]],void 0===e)return!1;return void 0===e[d[f]]||c?(e[d[f]]=Aa(b),!0):!1};
...
p.length&&m.push(n+":"+p.join(","))}return m.join(";")},zf=function(a,b,c){};var Af;a:{Af="G"}var Bf={"":"n",UA:"u",AW:"a",DC:"d",G:"e",GTM:Af},Cf=function(a){var b=kc.o.split("-"),c=b[0].toUpperCase();return(Bf[c]||"i")+"7g"+(a&&"GTM"===c?b[1]:"")};var Jf=!!B.MutationObserver,Kf=void 0,Lf=function(a){if(!Kf){var b=function(){var a=D.body;if(a)if(Jf)(new MutationObserver(function(){for(var a=0;a<Kf.length;a++)M(Kf[a])})).observe(a,{childList:!0,subtree:!0});else{var b=!1;Qa(a,"DOMNodeInserted",function(){b||(b=!0,M(function(){b=!1;for(var a=0;a<Kf.length;a++)M(Kf[a])}))})}};Kf=[];D.body?b():M(b)}Kf.push(a)};var Yf="www.googletagmanager.com/gtm.js";
...
var kg=function(){var a=Zf;if(qc){if(0===qc.toLowerCase().indexOf("https://"))return 2;if(0===qc.toLowerCase().indexOf("http://"))return 3}a=a.toLowerCase();for(var b="https://"+a,c="http://"+a,d=1,e=D.getElementsByTagName("script"),f=0;f<e.length&&100>f;f++){var h=e[f].src;if(h){h=h.toLowerCase();if(0===h.indexOf(c))return 3;1===d&&0===h.indexOf(b)&&(d=2)}}return d};var vg=function(a,b,c){var d=(void 0===c?0:c)?"www.googletagmanager.com/gtag/js":Zf;d+="?id="+encodeURIComponent(a)+"&l=dataLayer";if(b)for(var e in b)b[e]&&b.hasOwnProperty(e)&&(d+="&"+e+"="+encodeURIComponent(b[e]));var f=X("https://","http://",d);G(f,void 0,void 0)};var xg=function(a,b,c){a instanceof ke.Dc&&(a=a.resolve(ke.he(b,c)),b=rc);return{kb:a,R:b}};var yg=function(a,b,c){this.n=a;this.t=b;this.p=c},zg=function(){this.c=1;this.e=[];this.p=null};function Ag(a){var b=lc,c=b.gss=b.gss||{};return c[a]=c[a]||new zg}var Bg=function(a,b){Ag(a).p=b},Cg=function(a,b,c){var d=Math.floor((new Date).getTime()/1E3);Ag(a).e.push(new yg(b,d,c))},Dg=function(a){};var Mg=window,Ng=document,Og=function(a){var b=Mg._gaUserPrefs;if(b&&b.ioo&&b.ioo()||a&&!0===Mg["ga-disable-"+a])return!0;try{var c=Mg.external;if(c&&c._gaUserPrefs&&"oo"==c._gaUserPrefs)return!0}catch(m){}for(var d=[],e=Ng.cookie.split(";"),f=/^\s*AMP_TOKEN=\s*(.*?)\s*$/,h=0;h<e.length;h++){var k=e[h].match(f);k&&d.push(k[1])}for(var l=0;l<d.length;l++)if("$OPT_OUT"==decodeURIComponent(d[l]))return!0;return!1};var Rg=function(a){if(1===Ag(a).c){Ag(a).c=2;var b=encodeURIComponent(a);G(("http:"!=B.location.protocol?"https:":"http:")+("//www.googletagmanager.com/gtag/js?id="+b+"&l=dataLayer&cx=c"))}},Sg=function(a,b){};var Y={a:{}};
Y.a.jsm=["customScripts"],function(){(function(a){Y.__jsm=a;Y.__jsm.b="jsm";Y.__jsm.g=!0})(function(a){if(void 0!==a.vtp_javascript){var b=a.vtp_javascript;try{var c=V("google_tag_manager");return c&&c.e&&c.e(b)}catch(d){}}})}();
Y.a.e=["google"],function(){(function(a){Y.__e=a;Y.__e.b="e";Y.__e.g=!0})(function(){return mc})}();Y.a.f=["google"],function(){(function(a){Y.__f=a;Y.__f.b="f";Y.__f.g=!0})(function(a){var b=U("gtm.referrer",1)||D.referrer,c;if(b){var d;if(a.vtp_component&&"URL"!=a.vtp_component){var e=P(String(b));d=O(e,a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey)}else d=Ya(P(String(b)));c=d}else c=String(b);return c})}();
Y.a.cl=["google"],function(){function a(a){var b=a.target;if(b){var d=Ke(b);d.event="gtm.click";gg(d)}}(function(a){Y.__cl=a;Y.__cl.b="cl";Y.__cl.g=!0})(function(b){if(!rg("cl")){var c=V("document");Qa(c,"click",a,!0);sg("cl");var d=Ne("cl","legacyTeardown",void 0);d&&d()}M(b.vtp_gtmOnSuccess)})}();

Y.a.u=["google"],function(){var a=function(a){return{toString:function(){return a}}};(function(a){Y.__u=a;Y.__u.b="u";Y.__u.g=!0})(function(b){var c;c=(c=b.vtp_customUrlSource?b.vtp_customUrlSource:U("gtm.url",1))||eg();var d=b[a("vtp_component")],e;if(d&&"URL"!=d){var f=P(String(c));e=O(f,d,"HOST"==d?b[a("vtp_stripWww")]:void 0,"PATH"==d?b[a("vtp_defaultPages")]:void 0,"QUERY"==d?b[a("vtp_queryKey")]:void 0)}else e=Ya(P(String(c)));return e})}();
...
storage:!0,useAmpClientId:!0,storeGac:!0},t={allowAnchor:!0,allowLinker:!0,alwaysSendReferrer:!0,anonymizeIp:!0,cookieUpdate:!0,exFatal:!0,forceSSL:!0,javaEnabled:!0,legacyHistoryImport:!0,nonInteraction:!0,useAmpClientId:!0,useBeacon:!0,storeGac:!0,allowAdFeatures:!0},u=function(a){var b=[].slice.call(arguments,0);b[0]=p+b[0];n.apply(window,b)},A=function(a,b){return void 0===b?b:a(b)},F=function(a,b){if(b)for(var c in b)b.hasOwnProperty(c)&&u("set",a+c,b[c])},H=function(){},C=function(a,b,c){var d=0;if(a)for(var e in a)if(a.hasOwnProperty(e)&&(c&&r[e]||!c&&void 0===r[e])){var f=t[e]?wc(a[e]):a[e];"anonymizeIp"!=e||f||(f=void 0);b[e]=f;d++}return d},R={name:q};C(e,R,
!0);n("create",b.vtp_trackingId||c.trackingId,R);u("set","&gtm",Cf(!0));(function(a,c){void 0!==b[c]&&u("set",a,b[c])})("nonInteraction","vtp_nonInteraction");F("contentGroup",f);F("dimension",h);F("metric",k);var E={};C(e,E,!1)&&u("set",E);var K;b.vtp_enableLinkId&&u("require","linkid","linkid.js");u("set","hitCallback",function(){var a=
e&&e.hitCallback;sc(a)&&a();b.vtp_gtmOnSuccess()});if("TRACK_EVENT"==b.vtp_trackType){b.vtp_enableEcommerce&&(u("require","ec","ec.js"),H());var J={hitType:"event",eventCategory:String(b.vtp_eventCategory||c.category),eventAction:String(b.vtp_eventAction||c.action),eventLabel:A(String,b.vtp_eventLabel||c.label),eventValue:A(Ie,b.vtp_eventValue||c.value)};C(K,J,!1);u("send",J);}else if("TRACK_SOCIAL"==
...
b.vtp_trackType){}else{b.vtp_enableEcommerce&&(u("require","ec","ec.js"),H());if(b.vtp_doubleClick||"DISPLAY_FEATURES"==b.vtp_advertisingFeaturesType){var sa="_dc_gtm_"+String(b.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");u("require","displayfeatures",void 0,{cookieName:sa})}"DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==b.vtp_advertisingFeaturesType&&
(sa="_dc_gtm_"+String(b.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,""),u("require","adfeatures",{cookieName:sa}));K?u("send","pageview",K):u("send","pageview");}if(!a){var ia=b.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js";b.vtp_useInternalVersion&&!b.vtp_useDebugVersion&&
(ia="internal/"+ia);a=!0;dg(X("https:","http:","//www.google-analytics.com/"+ia,e&&e.forceSSL),function(){var a=ed();a&&a.loaded||b.vtp_gtmOnFailure();},b.vtp_gtmOnFailure)}};Y.__ua=b;Y.__ua.b="ua";Y.__ua.g=!0}();
...
a;Y.__aev.b="aev";Y.__aev.g=!0})(function(e){switch(e.vtp_varType){case "TEXT":var h,l=U("gtm.element",1),m=U("event",1),n=Number(new Date);a===l&&b===m&&c>n-250?h=d:(d=h=l?Ua(l):"",a=l,b=m);c=n;return h||e.vtp_defaultValue;case "URL":var p=String(U("gtm.elementUrl",1)||e.vtp_defaultValue||""),q=P(p);return e.vtp_component&&"URL"!=e.vtp_component?O(q,e.vtp_component,e.vtp_stripWww,e.vtp_defaultPages,e.vtp_queryKey):p;case "ATTRIBUTE":var r;if(void 0===e.vtp_attribute)r=f(e);else{var t=U("gtm.element",
1);r=Sa(t,e.vtp_attribute)||e.vtp_defaultValue||""}return r;default:return f(e)}})}();
Y.a.gas=["google"],function(){(function(a){Y.__gas=a;Y.__gas.b="gas";Y.__gas.g=!0})(function(a){var b=x(a,void 0),c=b;c[Q.L]=null;c[Q.yc]=null;var d=b=c;d.vtp_fieldsToSet=d.vtp_fieldsToSet||[];var e=d.vtp_cookieDomain;void 0!==e&&(d.vtp_fieldsToSet.push({fieldName:"cookieDomain",value:e}),delete d.vtp_cookieDomain);return b})}();
Y.a.ga=["google"],function(){var a,b,c=function(c){function d(a){var b=[].slice.call(arguments,0);b[0]=u+b[0];r.push(b)}function f(a,b){void 0!==c[b]&&d(a,c[b])}function h(a,b){void 0!==c[b]&&d(a,Number(c[b]))}function k(a,b){if(q(b))for(var c=0;c<b.length;c++)d(a,b[c])}function l(a,b,c){if(q(b))for(var e=0;e<b.length;e++){for(var f=[a],h=b[e],k=0;k<c.length;k++)f.push(h[c[k]]);d.apply(this,f)}}function m(a,b){void 0!==c[b]&&d("_set",a,c[b])}function n(a,b){return void 0===b?b:a(b)}function p(a,b){void 0!==
b&&(A+="&"+a+"="+b)}var q=qa,r=V("_gaq",[],!1),t=!1,u="";void 0==c.vtp_trackerName?u="gtm"+Bc()+".":""!==c.vtp_trackerName&&(u=c.vtp_trackerName+".");f("_setAccount","vtp_webPropertyId");d("_set","gtmid",Cf(!0));
...
A){var F=function(a,b,c){for(var d=b.length-1;0<=d;d--){var e=b[d].split("=");if(e[0]===a)return e[1]||"1"}for(var f=c.length-1;0<=f;f--){var h=c[f].split("=");if(h[0]===a)return h[1]||"1"}},H=P(eg()),C=O(H,"query",void 0,void 0,void 0).split("&"),R=c.vtp_allowAnchor?O(H,"fragment",void 0,void 0,void 0).split("&"):[];p("gclid",F("gclid",R,C));p("gclsrc",F("gclsrc",R,C));p("dclid",F("dclid",R,C));d("_set","campaignParams",A)}m("anonymizeIp",
...
"vtp_detectTitle");void 0!==c.vtp_forceSsl&&c.vtp_forceSsl&&(r.push(["_gat._forceSSL"]),t=!!c.vtp_forceSsl);d("_set","hitCallback",function(){sc(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});if("TRACK_EVENT"==c.vtp_trackType){d("_trackEvent",String(c.vtp_eventCategory),
String(c.vtp_eventAction),n(String,c.vtp_eventLabel),n(Ie,c.vtp_eventValue),!!c.vtp_nonInteraction);}else if("TRACK_TRANSACTION"==c.vtp_trackType){}else if("LINK"==c.vtp_trackType){}else if("LINK_BY_POST"==c.vtp_trackType){}else if("TRACK_SOCIAL"==c.vtp_trackType){}else if("TRACK_TIMING"==
...
var W=function(){V("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,bg(X("https","http","://stats.g.doubleclick.net/dc.js",t),W,c.vtp_gtmOnFailure));else if(!a){var ba=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;bg(X("https://ssl","http://www",ba,t),W,c.vtp_gtmOnFailure)}};Y.__ga=c;Y.__ga.b="ga";Y.__ga.g=!0}();
...
d.google_read_gcl_cookie_opt_out=!1):d.google_read_gcl_cookie_opt_out=!0;b.push(d);a||(a=!0,dg("//www.googleadservices.com/pagead/conversion_async.js",f(),e("//www.googleadservices.com/pagead/conversion_async.js")))};Y.__awct=h;Y.__awct.b="awct";Y.__awct.g=!0}();
...
".bizographics.com/insight.min.js");G(b,a.vtp_gtmOnSuccess,a.vtp_gtmOnFailure)}catch(c){M(a.vtp_gtmOnFailure)}})}();
...
else try{bg("//bat.bing.com/bat.js",function(){var a=Ee(V("UET"),{ti:b.vtp_tagId,q:d});B[c]=a;a.push("pageLoad");b.vtp_gtmOnSuccess()},b.vtp_gtmOnFailure),a=!0}catch(h){M(b.vtp_gtmOnFailure)}})}();



Y.a.html=["customScripts"],function(){var a=function(b,c,f,h){return function(){try{if(0<c.length){var d=c.shift(),e=a(b,c,f,h);if("SCRIPT"==String(d.nodeName).toUpperCase()&&"text/gtmscript"==d.type){var m=D.createElement("script");m.async=!1;m.type="text/javascript";m.id=d.id;m.text=d.text||d.textContent||d.innerHTML||"";d.charset&&(m.charset=d.charset);var n=d.getAttribute("data-gtmsrc");n&&(m.src=n,Oa(m,e));b.insertBefore(m,null);n||e()}else if(d.innerHTML&&0<=d.innerHTML.toLowerCase().indexOf("<script")){for(var p=
[];d.firstChild;)p.push(d.removeChild(d.firstChild));b.insertBefore(d,null);a(d,p,e,h)()}else b.insertBefore(d,null),e()}else f()}catch(q){M(h)}}};var c=function(d){if(D.body){var e=
d.vtp_gtmOnFailure,f=xg(d.vtp_html,d.vtp_gtmOnSuccess,e),h=f.kb,k=f.R;if(d.vtp_useIframe){}else d.vtp_supportDocumentWrite?b(h,k,e):a(D.body,Va(h),k,e)()}else ag(function(){c(d)},200)};Y.__html=c;Y.__html.b="html";Y.__html.g=!0}();
